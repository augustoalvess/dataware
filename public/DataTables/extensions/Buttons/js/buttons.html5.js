...
DataTable.ext.buttons.copyHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		var message = $('<span>'+dt.i18n( 'buttons.copyKeys',
				'Pressione as teclas <i>Ctrl</i> + <i>C</i> para copiar os dados da tabela <br>ao seu sistema de escritório<br><br>'+
				'Para cancelar, clique nesta mensagem ou pressione a tecla <i>Esc</i>' )+'</span>'
			)
			.append( $('<div/>')
				.css( {
					height: 1,
		...
		dt.buttons.info( dt.i18n( 'buttons.copyTitle', 'Copiar para sistema de escritório (<i>Word</i>, <i>Office</i>...)' ), message, 0 );
